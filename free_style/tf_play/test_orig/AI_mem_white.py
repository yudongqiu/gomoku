...
def strategy(state):
    ...
    if game_finished and strategy.started_from_beginning is True:
        ...
        for prev_state_zobrist_code in strategy.hist_states[::-1]:
            ...
            print("black: Updated U of %d from %f to %f"%(prev_state_zobrist_code, u, new_u))
            #discount *= discount_factor
        print("black: Updated win rate of %d states" % len(strategy.hist_states))
